...
#folder_country_data = 'DE_annual_data_country_level'
#get capacity data        
...
sys.exit()
if not os.path.exists(folder_country_data):
    os.mkdir(folder_country_data)
with open(folder_country_data + '\\GA_annual_data_country_level.dat', 'wb') as f:
    pickle.dump([solar_list, off_list, on_list, river_list, countries, cap_fact_pv_list, cap_fact_on_list, cap_fact_off_list, cap_fact_river_list, CR_correction_list, cap_hydro_list, f_star_hydro_iea_list, method_hydro], f)    
